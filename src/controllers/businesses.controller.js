...
class BusinessesController {
    ...
    static async addProductToBusiness(req, res, next) {
        ...
        const payload = req.body;
        try {
            const addedProductToBusiness = await businessesService.addProductToBusiness(bid, payload);
            const response = {
                success: true,
    ...
    static async updateBusinessById(req, res, next) {
        ...
        const payload = req.body;
        try {
            const updatedBusiness = await businessesService.updateBusinessById(bid, payload);
            const response = {
                success: true,
                updatedBusiness
            }
